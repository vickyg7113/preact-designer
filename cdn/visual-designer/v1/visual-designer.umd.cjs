(function(k,T){typeof exports=="object"&&typeof module<"u"?T(exports):typeof define=="function"&&define.amd?define(["exports"],T):(k=typeof globalThis<"u"?globalThis:k||self,T(k.VisualDesigner={}))})(this,(function(k){"use strict";class T{static generateSelector(e){if(e.id)return{selector:`#${this.escapeSelector(e.id)}`,confidence:"high",method:"id"};if(e.hasAttribute("data-testid")){const r=e.getAttribute("data-testid");return{selector:`[data-testid="${this.escapeAttribute(r)}"]`,confidence:"high",method:"data-testid"}}const n=this.getSemanticDataAttributes(e);if(n.length>0){const r=n[0],s=e.getAttribute(r);return{selector:`[${r}="${this.escapeAttribute(s)}"]`,confidence:"high",method:"data-attribute"}}const i=this.generateAriaSelector(e);if(i)return{selector:i,confidence:"medium",method:"aria"};const o=this.generatePathSelector(e);return o?{selector:o,confidence:"medium",method:"path"}:{selector:e.tagName.toLowerCase(),confidence:"low",method:"tag"}}static findElement(e){try{return document.querySelector(e)}catch{return null}}static validateSelector(e){try{return document.querySelector(e)!==null}catch{return!1}}static getSemanticDataAttributes(e){const n=["data-id","data-name","data-role","data-component","data-element"],i=[];for(const o of n)e.hasAttribute(o)&&i.push(o);for(let o=0;o<e.attributes.length;o++){const r=e.attributes[o];r.name.startsWith("data-")&&!i.includes(r.name)&&i.push(r.name)}return i}static generateAriaSelector(e){const n=e.getAttribute("role"),i=e.getAttribute("aria-label");if(n){let o=`[role="${this.escapeAttribute(n)}"]`;return i&&(o+=`[aria-label="${this.escapeAttribute(i)}"]`),o}return null}static generatePathSelector(e){const n=[];let i=e;for(;i&&i!==document.body&&i!==document.documentElement;){let o=i.tagName.toLowerCase();if(i.id){o+=`#${this.escapeSelector(i.id)}`,n.unshift(o);break}if(i.className&&typeof i.className=="string"){const s=i.className.split(/\s+/).filter(l=>l&&!l.startsWith("designer-")).slice(0,2);s.length>0&&(o+="."+s.map(l=>this.escapeSelector(l)).join("."))}const r=i.parentElement;if(r){const s=Array.from(r.children).filter(l=>l.tagName===i.tagName);s.length>1&&(o+=`:nth-of-type(${s.indexOf(i)+1})`)}if(n.unshift(o),i=r,n.length>=5)break}return n.length>0?n.join(" > "):null}static escapeSelector(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):e.replace(/([!"#$%&'()*+,.\/:;<=>?@[\\\]^`{|}~])/g,"\\$1")}static escapeAttribute(e){return e.replace(/"/g,'\\"').replace(/'/g,"\\'")}}function Ie(t){const e=t.getBoundingClientRect(),n={};for(let i=0;i<t.attributes.length;i++){const o=t.attributes[i];n[o.name]=o.value}return{tagName:t.tagName.toLowerCase(),id:t.id||void 0,className:t.className?.toString()||void 0,textContent:t.textContent?.trim().substring(0,50)||void 0,attributes:n,boundingRect:e}}function re(t){const e=window.getComputedStyle(t);return e.display!=="none"&&e.visibility!=="hidden"&&e.opacity!=="0"&&t.getBoundingClientRect().height>0&&t.getBoundingClientRect().width>0}function Y(){return window.location.pathname||"/"}function oe(){return`${Date.now()}-${Math.random().toString(36).substr(2,9)}`}function Te(t){const e=t.getBoundingClientRect();return e.top>=0&&e.left>=0&&e.bottom<=(window.innerHeight||document.documentElement.clientHeight)&&e.right<=(window.innerWidth||document.documentElement.clientWidth)}function Le(t){Te(t)||t.scrollIntoView({behavior:"smooth",block:"center"})}const ae="#designer-editor-frame, #designer-highlight-overlay, #designer-exit-editor-btn, #designer-red-border-overlay, #designer-studio-badge";class Me{isActive=!1;highlightOverlay=null;messageCallback=null;activate(e){this.isActive||(this.isActive=!0,this.messageCallback=e,this.createHighlightOverlay(),this.attachEventListeners(),this.addEditorStyles())}deactivate(){this.isActive&&(this.isActive=!1,this.removeEventListeners(),this.removeHighlightOverlay(),this.removeEditorStyles(),this.messageCallback=null)}getActive(){return this.isActive}createHighlightOverlay(){if(!document.body){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.createHighlightOverlay());return}setTimeout(()=>this.createHighlightOverlay(),100);return}this.highlightOverlay=document.createElement("div"),this.highlightOverlay.id="designer-highlight-overlay",this.highlightOverlay.style.cssText=`
      position: absolute;
      pointer-events: none;
      ...
      display: none;
    `,document.body.appendChild(this.highlightOverlay)}removeHighlightOverlay(){this.highlightOverlay?.remove(),this.highlightOverlay=null}attachEventListeners(){document.addEventListener("mouseover",this.handleMouseOver,!0),document.addEventListener("click",this.handleClick,!0),document.addEventListener("keydown",this.handleKeyDown,!0)}removeEventListeners(){document.removeEventListener("mouseover",this.handleMouseOver,!0),document.removeEventListener("click",this.handleClick,!0),document.removeEventListener("keydown",this.handleKeyDown,!0)}handleMouseOver=e=>{if(!this.isActive||!this.highlightOverlay)return;const n=e.target;if(!(!n||n===this.highlightOverlay)){if(n.closest(ae)){this.hideHighlight();return}if(!re(n)){this.hideHighlight();return}this.highlightElement(n)}};handleClick=e=>{if(!this.isActive)return;const n=e.target;n&&(n.closest(ae)||(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),re(n)&&this.selectElement(n)))};handleKeyDown=e=>{this.isActive&&e.key==="Escape"&&(this.messageCallback?.({type:"CANCEL"}),this.hideHighlight())};highlightElement(e){if(!this.highlightOverlay)return;const n=e.getBoundingClientRect(),i=window.pageXOffset||document.documentElement.scrollLeft,o=window.pageYOffset||document.documentElement.scrollTop;this.highlightOverlay.style.display="block",this.highlightOverlay.style.left=`${n.left+i}px`,this.highlightOverlay.style.top=`${n.top+o}px`,this.highlightOverlay.style.width=`${n.width}px`,this.highlightOverlay.style.height=`${n.height}px`}hideHighlight(){this.highlightOverlay&&(this.highlightOverlay.style.display="none")}selectElement(e){this.highlightElement(e);const n=T.generateSelector(e),i=Ie(e);this.messageCallback?.({type:"ELEMENT_SELECTED",selector:n.selector,elementInfo:i})}addEditorStyles(){const e=document.createElement("style");e.id="designer-editor-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}removeEditorStyles(){document.getElementById("designer-editor-styles")?.remove()}}var R,f,se,L,de,le,ce,ge,j,W,X,A={},ue=[],Be=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,U=Array.isArray;function S(t,e){for(var n in e)t[n]=e[n];return t}function q(t){t&&t.parentNode&&t.parentNode.removeChild(t)}function De(t,e,n){var i,o,r,s={};for(r in e)r=="key"?i=e[r]:r=="ref"?o=e[r]:s[r]=e[r];if(arguments.length>2&&(s.children=arguments.length>3?R.call(arguments,2):n),typeof t=="function"&&t.defaultProps!=null)for(r in t.defaultProps)s[r]===void 0&&(s[r]=t.defaultProps[r]);return N(t,s,i,o,null)}function N(t,e,n,i,o){var r={type:t,props:e,key:n,ref:i,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:o??++se,__i:-1,__u:0};return o==null&&f.vnode!=null&&f.vnode(r),r}function P(t){return t.children}function G(t,e){this.props=t,this.context=e}function B(t,e){if(e==null)return t.__?B(t.__,t.__i+1):null;for(var n;e<t.__k.length;e++)if((n=t.__k[e])!=null&&n.__e!=null)return n.__e;return typeof t.type=="function"?B(t):null}function pe(t){var e,n;if((t=t.__)!=null&&t.__c!=null){for(t.__e=t.__c.base=null,e=0;e<t.__k.length;e++)if((n=t.__k[e])!=null&&n.__e!=null){t.__e=t.__c.base=n.__e;break}return pe(t)}}function fe(t){(!t.__d&&(t.__d=!0)&&L.push(t)&&!H.__r++||de!=f.debounceRendering)&&((de=f.debounceRendering)||le)(H)}function H(){for(var t,e,n,i,o,r,s,l=1;L.length;)L.length>l&&L.sort(ce),t=L.shift(),l=L.length,t.__d&&(n=void 0,i=void 0,o=(i=(e=t).__v).__e,r=[],s=[],e.__P&&((n=S({},i)).__v=i.__v+1,f.vnode&&f.vnode(n),J(e.__P,n,i,e.__n,e.__P.namespaceURI,32&i.__u?[o]:null,r,o??B(i),!!(32&i.__u),s),n.__v=i.__v,n.__.__k[n.__i]=n,ye(r,n,s),i.__e=i.__=null,n.__e!=o&&pe(n)));H.__r=0}function he(t,e,n,i,o,r,s,l,g,d,c){var a,v,u,y,w,x,m,h=i&&i.__k||ue,I=e.length;for(g=Ae(n,e,h,g,I),a=0;a<I;a++)(u=n.__k[a])!=null&&(v=u.__i==-1?A:h[u.__i]||A,u.__i=a,x=J(t,u,v,o,r,s,l,g,d,c),y=u.__e,u.ref&&v.ref!=u.ref&&(v.ref&&Z(v.ref,null,u),c.push(u.ref,u.__c||y,u)),w==null&&y!=null&&(w=y),(m=!!(4&u.__u))||v.__k===u.__k?g=me(u,g,t,m):typeof u.type=="function"&&x!==void 0?g=x:y&&(g=y.nextSibling),u.__u&=-7);return n.__e=w,g}function Ae(t,e,n,i,o){var r,s,l,g,d,c=n.length,a=c,v=0;for(t.__k=new Array(o),r=0;r<o;r++)(s=e[r])!=null&&typeof s!="boolean"&&typeof s!="function"?(typeof s=="string"||typeof s=="number"||typeof s=="bigint"||s.constructor==String?s=t.__k[r]=N(null,s,null,null,null):U(s)?s=t.__k[r]=N(P,{children:s},null,null,null):s.constructor===void 0&&s.__b>0?s=t.__k[r]=N(s.type,s.props,s.key,s.ref?s.ref:null,s.__v):t.__k[r]=s,g=r+v,s.__=t,s.__b=t.__b+1,l=null,(d=s.__i=Pe(s,n,g,a))!=-1&&(a--,(l=n[d])&&(l.__u|=2)),l==null||l.__v==null?(d==-1&&(o>c?v--:o<c&&v++),typeof s.type!="function"&&(s.__u|=4)):d!=g&&(d==g-1?v--:d==g+1?v++:(d>g?v--:v++,s.__u|=4))):t.__k[r]=null;if(a)for(r=0;r<c;r++)(l=n[r])!=null&&(2&l.__u)==0&&(l.__e==i&&(i=B(l)),_e(l,l));return i}function me(t,e,n,i){var o,r;if(typeof t.type=="function"){for(o=t.__k,r=0;o&&r<o.length;r++)o[r]&&(o[r].__=t,e=me(o[r],e,n,i));return e}t.__e!=e&&(i&&(e&&t.type&&!e.parentNode&&(e=B(t)),n.insertBefore(t.__e,e||null)),e=t.__e);do e=e&&e.nextSibling;while(e!=null&&e.nodeType==8);return e}function Pe(t,e,n,i){var o,r,s,l=t.key,g=t.type,d=e[n],c=d!=null&&(2&d.__u)==0;if(d===null&&l==null||c&&l==d.key&&g==d.type)return n;if(i>(c?1:0)){for(o=n-1,r=n+1;o>=0||r<e.length;)if((d=e[s=o>=0?o--:r++])!=null&&(2&d.__u)==0&&l==d.key&&g==d.type)return s}return-1}function be(t,e,n){e[0]=="-"?t.setProperty(e,n??""):t[e]=n==null?"":typeof n!="number"||Be.test(e)?n:n+"px"}function V(t,e,n,i,o){var r,s;e:if(e=="style")if(typeof n=="string")t.style.cssText=n;else{if(typeof i=="string"&&(t.style.cssText=i=""),i)for(e in i)n&&e in n||be(t.style,e,"");if(n)for(e in n)i&&n[e]==i[e]||be(t.style,e,n[e])}else if(e[0]=="o"&&e[1]=="n")r=e!=(e=e.replace(ge,"$1")),s=e.toLowerCase(),e=s in t||e=="onFocusOut"||e=="onFocusIn"?s.slice(2):e.slice(2),t.l||(t.l={}),t.l[e+r]=n,n?i?n.u=i.u:(n.u=j,t.addEventListener(e,r?X:W,r)):t.removeEventListener(e,r?X:W,r);else{if(o=="http://www.w3.org/2000/svg")e=e.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if(e!="width"&&e!="height"&&e!="href"&&e!="list"&&e!="form"&&e!="tabIndex"&&e!="download"&&e!="rowSpan"&&e!="colSpan"&&e!="role"&&e!="popover"&&e in t)try{t[e]=n??"";break e}catch{}typeof n=="function"||(n==null||n===!1&&e[4]!="-"?t.removeAttribute(e):t.setAttribute(e,e=="popover"&&n==1?"":n))}}function ve(t){return function(e){if(this.l){var n=this.l[e.type+t];if(e.t==null)e.t=j++;else if(e.t<n.u)return;return n(f.event?f.event(e):e)}}}function J(t,e,n,i,o,r,s,l,g,d){var c,a,v,u,y,w,x,m,h,I,M,K,F,Ce,$,O,ie,E=e.type;if(e.constructor!==void 0)return null;128&n.__u&&(g=!!(32&n.__u),r=[l=e.__e=n.__e]),(c=f.__b)&&c(e);e:if(typeof E=="function")try{if(m=e.props,h="prototype"in E&&E.prototype.render,I=(c=E.contextType)&&i[c.__c],M=c?I?I.props.value:c.__:i,n.__c?x=(a=e.__c=n.__c).__=a.__E:(h?e.__c=a=new E(m,M):(e.__c=a=new G(m,M),a.constructor=E,a.render=Fe),I&&I.sub(a),a.state||(a.state={}),a.__n=i,v=a.__d=!0,a.__h=[],a._sb=[]),h&&a.__s==null&&(a.__s=a.state),h&&E.getDerivedStateFromProps!=null&&(a.__s==a.state&&(a.__s=S({},a.__s)),S(a.__s,E.getDerivedStateFromProps(m,a.__s))),u=a.props,y=a.state,a.__v=e,v)h&&E.getDerivedStateFromProps==null&&a.componentWillMount!=null&&a.componentWillMount(),h&&a.componentDidMount!=null&&a.__h.push(a.componentDidMount);else{if(h&&E.getDerivedStateFromProps==null&&m!==u&&a.componentWillReceiveProps!=null&&a.componentWillReceiveProps(m,M),e.__v==n.__v||!a.__e&&a.shouldComponentUpdate!=null&&a.shouldComponentUpdate(m,a.__s,M)===!1){for(e.__v!=n.__v&&(a.props=m,a.state=a.__s,a.__d=!1),e.__e=n.__e,e.__k=n.__k,e.__k.some(function(D){D&&(D.__=e)}),K=0;K<a._sb.length;K++)a.__h.push(a._sb[K]);a._sb=[],a.__h.length&&s.push(a);break e}a.componentWillUpdate!=null&&a.componentWillUpdate(m,a.__s,M),h&&a.componentDidUpdate!=null&&a.__h.push(function(){a.componentDidUpdate(u,y,w)})}if(a.context=M,a.props=m,a.__P=t,a.__e=!1,F=f.__r,Ce=0,h){for(a.state=a.__s,a.__d=!1,F&&F(e),c=a.render(a.props,a.state,a.context),$=0;$<a._sb.length;$++)a.__h.push(a._sb[$]);a._sb=[]}else do a.__d=!1,F&&F(e),c=a.render(a.props,a.state,a.context),a.state=a.__s;while(a.__d&&++Ce<25);a.state=a.__s,a.getChildContext!=null&&(i=S(S({},i),a.getChildContext())),h&&!v&&a.getSnapshotBeforeUpdate!=null&&(w=a.getSnapshotBeforeUpdate(u,y)),O=c,c!=null&&c.type===P&&c.key==null&&(O=xe(c.props.children)),l=he(t,U(O)?O:[O],e,n,i,o,r,s,l,g,d),a.base=e.__e,e.__u&=-161,a.__h.length&&s.push(a),x&&(a.__E=a.__=null)}catch(D){if(e.__v=null,g||r!=null)if(D.then){for(e.__u|=g?160:128;l&&l.nodeType==8&&l.nextSibling;)l=l.nextSibling;r[r.indexOf(l)]=null,e.__e=l}else{for(ie=r.length;ie--;)q(r[ie]);Q(e)}else e.__e=n.__e,e.__k=n.__k,D.then||Q(e);f.__e(D,e,n)}else r==null&&e.__v==n.__v?(e.__k=n.__k,e.__e=n.__e):l=e.__e=ze(n.__e,e,n,i,o,r,s,g,d);return(c=f.diffed)&&c(e),128&e.__u?void 0:l}function Q(t){t&&t.__c&&(t.__c.__e=!0),t&&t.__k&&t.__k.forEach(Q)}function ye(t,e,n){for(var i=0;i<n.length;i++)Z(n[i],n[++i],n[++i]);f.__c&&f.__c(e,t),t.some(function(o){try{t=o.__h,o.__h=[],t.some(function(r){r.call(o)})}catch(r){f.__e(r,o.__v)}})}function xe(t){return typeof t!="object"||t==null||t.__b&&t.__b>0?t:U(t)?t.map(xe):S({},t)}function ze(t,e,n,i,o,r,s,l,g){var d,c,a,v,u,y,w,x=n.props||A,m=e.props,h=e.type;if(h=="svg"?o="http://www.w3.org/2000/svg":h=="math"?o="http://www.w3.org/1998/Math/MathML":o||(o="http://www.w3.org/1999/xhtml"),r!=null){for(d=0;d<r.length;d++)if((u=r[d])&&"setAttribute"in u==!!h&&(h?u.localName==h:u.nodeType==3)){t=u,r[d]=null;break}}if(t==null){if(h==null)return document.createTextNode(m);t=document.createElementNS(o,h,m.is&&m),l&&(f.__m&&f.__m(e,r),l=!1),r=null}if(h==null)x===m||l&&t.data==m||(t.data=m);else{if(r=r&&R.call(t.childNodes),!l&&r!=null)for(x={},d=0;d<t.attributes.length;d++)x[(u=t.attributes[d]).name]=u.value;for(d in x)if(u=x[d],d!="children"){if(d=="dangerouslySetInnerHTML")a=u;else if(!(d in m)){if(d=="value"&&"defaultValue"in m||d=="checked"&&"defaultChecked"in m)continue;V(t,d,null,u,o)}}for(d in m)u=m[d],d=="children"?v=u:d=="dangerouslySetInnerHTML"?c=u:d=="value"?y=u:d=="checked"?w=u:l&&typeof u!="function"||x[d]===u||V(t,d,u,x[d],o);if(c)l||a&&(c.__html==a.__html||c.__html==t.innerHTML)||(t.innerHTML=c.__html),e.__k=[];else if(a&&(t.innerHTML=""),he(e.type=="template"?t.content:t,U(v)?v:[v],e,n,i,h=="foreignObject"?"http://www.w3.org/1999/xhtml":o,r,s,r?r[0]:n.__k&&B(n,0),l,g),r!=null)for(d=r.length;d--;)q(r[d]);l||(d="value",h=="progress"&&y==null?t.removeAttribute("value"):y!=null&&(y!==t[d]||h=="progress"&&!y||h=="option"&&y!=x[d])&&V(t,d,y,x[d],o),d="checked",w!=null&&w!=t[d]&&V(t,d,w,x[d],o))}return t}function Z(t,e,n){try{if(typeof t=="function"){var i=typeof t.__u=="function";i&&t.__u(),i&&e==null||(t.__u=t(e))}else t.current=e}catch(o){f.__e(o,n)}}function _e(t,e,n){var i,o;if(f.unmount&&f.unmount(t),(i=t.ref)&&(i.current&&i.current!=t.__e||Z(i,null,e)),(i=t.__c)!=null){if(i.componentWillUnmount)try{i.componentWillUnmount()}catch(r){f.__e(r,e)}i.base=i.__P=null}if(i=t.__k)for(o=0;o<i.length;o++)i[o]&&_e(i[o],e,n||typeof t.type!="function");n||q(t.__e),t.__c=t.__=t.__e=void 0}function Fe(t,e,n){return this.constructor(t,n)}function z(t,e,n){var i,o,r,s;e==document&&(e=document.documentElement),f.__&&f.__(t,e),o=(i=!1)?null:e.__k,r=[],s=[],J(e,t=e.__k=De(P,null,[t]),o||A,A,e.namespaceURI,o?null:e.firstChild?R.call(e.childNodes):null,r,o?o.__e:e.firstChild,i,s),ye(r,t,s)}R=ue.slice,f={__e:function(t,e,n,i){for(var o,r,s;e=e.__;)if((o=e.__c)&&!o.__)try{if((r=o.constructor)&&r.getDerivedStateFromError!=null&&(o.setState(r.getDerivedStateFromError(t)),s=o.__d),o.componentDidCatch!=null&&(o.componentDidCatch(t,i||{}),s=o.__d),s)return o.__E=o}catch(l){t=l}throw t}},se=0,G.prototype.setState=function(t,e){var n;n=this.__s!=null&&this.__s!=this.state?this.__s:this.__s=S({},this.state),typeof t=="function"&&(t=t(S({},n),this.props)),t&&S(n,t),t!=null&&this.__v&&(e&&this._sb.push(e),fe(this))},G.prototype.forceUpdate=function(t){this.__v&&(this.__e=!0,t&&this.__h.push(t),fe(this))},G.prototype.render=P,L=[],le=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,ce=function(t,e){return t.__v.__b-e.__v.__b},H.__r=0,ge=/(PointerCapture)$|Capture$/i,j=0,W=ve(!1),X=ve(!0);var Oe=0;function b(t,e,n,i,o,r){e||(e={});var s,l,g=e;if("ref"in g)for(l in g={},e)l=="ref"?s=e[l]:g[l]=e[l];var d={type:t,props:g,key:n,ref:s,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:--Oe,__i:-1,__u:0,__source:o,__self:r};if(typeof t=="function"&&(s=t.defaultProps))for(l in s)g[l]===void 0&&(g[l]=s[l]);return f.vnode&&f.vnode(d),d}const p={fontFamily:"'Montserrat', -apple-system, BlinkMacSystemFont, sans-serif",primary:"#3b82f6",text:"#111827",bg:"#ffffff",shadow:"0 4px 12px rgba(0, 0, 0, 0.15)",shadowHover:"0 6px 16px rgba(0, 0, 0, 0.2)",borderRadius:"8px",zIndex:{overlay:999995,guides:999996,tooltip:999997,highlight:999998,controls:1e6,badge:1000001,loading:1000002}};function Re({guide:t,top:e,left:n,arrowStyle:i,onDismiss:o}){return b("div",{className:"designer-guide-tooltip","data-guide-id":t.id,style:{position:"absolute",background:p.bg,border:`2px solid ${p.primary}`,borderRadius:p.borderRadius,padding:"12px 16px",boxShadow:"0 10px 25px rgba(0, 0, 0, 0.15)",zIndex:p.zIndex.tooltip,maxWidth:300,fontFamily:p.fontFamily,fontSize:14,lineHeight:1.5,color:p.text,top:`${e}px`,left:`${n}px`,pointerEvents:"auto"},children:[b("div",{style:{marginBottom:8},children:t.content}),b("button",{type:"button",onClick:o,style:{background:p.primary,color:p.bg,border:"none",borderRadius:4,padding:"6px 12px",fontSize:12,fontWeight:500,cursor:"pointer",transition:"background 0.2s"},children:"Got it"}),b("div",{className:"designer-guide-arrow",style:{position:"absolute",width:0,height:0,borderStyle:"solid",...i}})]})}function Ue(t){const e={position:"absolute"};switch(t){case"top":return{...e,bottom:"-8px",left:"50%",transform:"translateX(-50%)",borderWidth:"8px 8px 0 8px",borderColor:`${p.primary} transparent transparent transparent`};case"bottom":return{...e,top:"-8px",left:"50%",transform:"translateX(-50%)",borderWidth:"0 8px 8px 8px",borderColor:`transparent transparent ${p.primary} transparent`};case"left":return{...e,right:"-8px",top:"50%",transform:"translateY(-50%)",borderWidth:"8px 0 8px 8px",borderColor:`transparent transparent transparent ${p.primary}`};default:return{...e,left:"-8px",top:"50%",transform:"translateY(-50%)",borderWidth:"8px 8px 8px 0",borderColor:`transparent ${p.primary} transparent transparent`}}}function Ne(t,e,n,i){const o=t.getBoundingClientRect(),r=window.pageXOffset||document.documentElement.scrollLeft,s=window.pageYOffset||document.documentElement.scrollTop,l=window.innerWidth,g=window.innerHeight;let d=0,c=0;switch(e){case"top":d=o.top+s-i-12,c=o.left+r+o.width/2-n/2;break;case"bottom":d=o.bottom+s+12,c=o.left+r+o.width/2-n/2;break;case"left":d=o.top+s+o.height/2-i/2,c=o.left+r-n-12;break;default:d=o.top+s+o.height/2-i/2,c=o.right+r+12;break}return c<r?c=r+10:c+n>r+l&&(c=r+l-n-10),d<s?d=s+10:d+i>s+g&&(d=s+g-i-10),{top:d,left:c,arrowStyle:Ue(e)}}class Ge{container=null;onDismiss=()=>{};lastGuides=[];dismissedThisSession=new Set;setOnDismiss(e){this.onDismiss=e}renderGuides(e){this.lastGuides=e;const n=Y(),i=e.filter(r=>r.page===n&&r.status==="active"&&!this.dismissedThisSession.has(r.id));if(i.length===0||(this.ensureContainer(),!this.container))return;const o=[];for(const r of i){const s=T.findElement(r.selector);if(!s)continue;Le(s);const l=Ne(s,r.placement,280,80);o.push({guide:r,target:s,pos:l})}z(b("div",{id:"designer-guides-container",style:{position:"absolute",top:0,left:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:p.zIndex.guides},children:o.map(({guide:r,pos:s})=>b(Re,{guide:r,top:s.top,left:s.left,arrowStyle:s.arrowStyle,onDismiss:()=>this.dismissGuide(r.id)},r.id))}),this.container)}updatePositions(e){this.renderGuides(e)}dismissGuide(e){this.dismissedThisSession.add(e),this.onDismiss(e),this.renderGuides(this.lastGuides)}clear(){this.dismissedThisSession.clear(),this.container&&z(null,this.container)}ensureContainer(){if(!this.container){if(!document.body){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.ensureContainer());return}setTimeout(()=>this.ensureContainer(),100);return}this.container=document.createElement("div"),this.container.id="designer-guides-root",document.body.appendChild(this.container)}}}const we=["rgba(251, 191, 36, 0.35)","rgba(34, 197, 94, 0.35)","rgba(249, 115, 22, 0.35)"];function He({feature:t,color:e,rect:n}){const i=window.pageXOffset||document.documentElement.scrollLeft,o=window.pageYOffset||document.documentElement.scrollTop;return b("div",{className:"designer-feature-heatmap-overlay",title:t.featureName,style:{position:"absolute",left:n.left+i,top:n.top+o,width:n.width,height:n.height,backgroundColor:e,pointerEvents:"none",zIndex:p.zIndex.overlay,boxSizing:"border-box",borderRadius:4,border:`2px solid ${e}`}})}function Ee(t){return(t||"").replace(/^https?:\/\//i,"").replace(/\/$/,"").trim()||""}function Ve(){try{return window.location.href||""}catch{return""}}class Ke{container=null;lastEnabled=!1;render(e,n){if(this.lastEnabled=n,this.clear(),!n||e.length===0)return;const i=Ve(),o=Ee(i),r=e.filter(l=>l.url&&Ee(l.url)===o);if(r.length===0||(this.ensureContainer(),!this.container))return;const s=r.map((l,g)=>{const d=T.findElement(l.selector);if(!d)return null;const c=d.getBoundingClientRect(),a=we[g%we.length];return{feature:l,rect:c,color:a}}).filter(Boolean);z(b("div",{id:"designer-feature-heatmap-container",style:{position:"absolute",top:0,left:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:p.zIndex.overlay-1},children:s.map(({feature:l,rect:g,color:d})=>b(He,{feature:l,color:d,rect:{left:g.left,top:g.top,width:g.width,height:g.height}},l.id))}),this.container)}updatePositions(e){this.render(e,this.lastEnabled)}clear(){this.container&&z(null,this.container)}destroy(){this.clear(),this.container?.remove(),this.container=null}ensureContainer(){if(!this.container){if(!document.body){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.ensureContainer());return}setTimeout(()=>this.ensureContainer(),100);return}this.container=document.createElement("div"),this.container.id="designer-feature-heatmap-root",document.body.appendChild(this.container)}}}class $e{iframe=null;dragHandle=null;gripButton=null;messageCallback=null;isReady=!1;mode=null;isDragging=!1;dragStartX=0;dragStartY=0;dragThreshold=3;mouseDownX=0;mouseDownY=0;isMouseDown=!1;create(e,n){if(console.log("[Visual Designer] EditorFrame.create() called with mode:",n),this.iframe){console.warn("[Visual Designer] EditorFrame already created, skipping");return}this.mode=n||null,this.messageCallback=e,console.log("[Visual Designer] Creating editor iframe with mode:",this.mode),this.iframe=document.createElement("iframe"),this.iframe.id="designer-editor-frame",this.iframe.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 600px;
...
<body>
  ...
  <\/script>
    ...
    `,e.onmouseenter=()=>{e.style.background="transparent",e.style.border="none"},e.onmouseleave=()=>{e.style.background="transparent",e.style.border="none"};const n=document.createElement("iconify-icon");n.setAttribute("icon","pepicons-print:dots-x"),n.style.cssText="font-size: 18px; color: #64748b; pointer-events: none;",e.appendChild(n),this.dragHandle.appendChild(e),this.gripButton=e,e.addEventListener("mousedown",this.handleMouseDown,!0),document.addEventListener("mousemove",this.handleMouseMove,!0),document.addEventListener("mouseup",this.handleMouseUp,!0),window.addEventListener("mousemove",this.handleMouseMove,!0),window.addEventListener("mouseup",this.handleMouseUp,!0)}updateDragHandlePosition(){if(!this.iframe||!this.dragHandle)return;const e=this.iframe.getBoundingClientRect();this.dragHandle.style.top=`${e.top}px`,this.dragHandle.style.left=`${e.left}px`,this.dragHandle.style.width=`${e.width}px`}handleMouseDown=e=>{if(!this.iframe||!this.dragHandle)return;this.mouseDownX=e.clientX,this.mouseDownY=e.clientY,this.isMouseDown=!0,this.isDragging=!1;const n=this.iframe.getBoundingClientRect();this.dragStartX=e.clientX-n.left,this.dragStartY=e.clientY-n.top,e.preventDefault(),e.stopPropagation()};handleMouseMove=e=>{if(!this.isMouseDown||!this.iframe||!this.dragHandle)return;if(!this.isDragging){const d=Math.abs(e.clientX-this.mouseDownX),c=Math.abs(e.clientY-this.mouseDownY);if(Math.sqrt(d*d+c*c)>this.dragThreshold)this.isDragging=!0,document.body.style.cursor="grabbing",document.documentElement.style.cursor="grabbing",document.body.style.userSelect="none",document.documentElement.style.userSelect="none",this.iframe&&(this.iframe.style.pointerEvents="none"),this.gripButton&&(this.gripButton.style.cursor="grabbing");else return}e.preventDefault(),e.stopPropagation();const n=e.clientX-this.dragStartX,i=e.clientY-this.dragStartY,o=window.innerWidth,r=window.innerHeight,s=this.iframe.offsetWidth,l=Math.max(-s+50,Math.min(n,o-50)),g=Math.max(0,Math.min(i,r-100));this.iframe.style.left=`${l}px`,this.iframe.style.top=`${g}px`,this.iframe.style.right="auto",this.iframe.style.bottom="auto",this.dragHandle.style.left=`${l}px`,this.dragHandle.style.top=`${g}px`};handleMouseUp=e=>{this.isMouseDown&&(this.isDragging=!1,this.isMouseDown=!1,document.body.style.cursor="",document.documentElement.style.cursor="",document.body.style.userSelect="",document.documentElement.style.userSelect="",this.iframe&&(this.iframe.style.pointerEvents=""),this.gripButton&&(this.gripButton.style.cursor="grab"),e.preventDefault(),e.stopPropagation())};handleMessage=e=>{const n=e.data;!n||!n.type||(this.messageCallback&&this.messageCallback(n),(n.type==="CANCEL"||n.type==="GUIDE_SAVED")&&this.hide())}}const Ye="visual-designer-guides",ke="1.0.0";class je{storageKey;constructor(e=Ye){this.storageKey=e}getGuides(){try{const e=localStorage.getItem(this.storageKey);if(!e)return[];const n=JSON.parse(e);return n.version!==ke?(this.clear(),[]):n.guides||[]}catch{return[]}}getGuidesByPage(e){return this.getGuides().filter(i=>i.page===e&&i.status==="active")}saveGuide(e){const n=this.getGuides(),i=n.findIndex(r=>r.id===e.id),o={...e,updatedAt:new Date().toISOString(),createdAt:e.createdAt||new Date().toISOString()};i>=0?n[i]=o:n.push(o),this.saveGuides(n)}deleteGuide(e){const n=this.getGuides().filter(i=>i.id!==e);this.saveGuides(n)}saveGuides(e){const n={guides:e,version:ke};localStorage.setItem(this.storageKey,JSON.stringify(n))}clear(){localStorage.removeItem(this.storageKey)}getGuide(e){return this.getGuides().find(n=>n.id===e)||null}}function We({onExit:t}){const e={position:"fixed",top:"20px",right:"20px",padding:"10px 20px",background:p.bg,border:`2px solid ${p.primary}`,borderRadius:p.borderRadius,color:p.primary,fontSize:"14px",fontWeight:"600",fontFamily:p.fontFamily,cursor:"pointer",zIndex:String(p.zIndex.controls),boxShadow:p.shadow,transition:"all 0.2s ease",pointerEvents:"auto"};return b("button",{id:"designer-exit-editor-btn",style:e,onClick:t,onMouseEnter:n=>{n.currentTarget.style.background=p.primary,n.currentTarget.style.color=p.bg,n.currentTarget.style.transform="translateY(-2px)",n.currentTarget.style.boxShadow=p.shadowHover},onMouseLeave:n=>{n.currentTarget.style.background=p.bg,n.currentTarget.style.color=p.primary,n.currentTarget.style.transform="translateY(0)",n.currentTarget.style.boxShadow=p.shadow},children:[b("iconify-icon",{icon:"mdi:exit-to-app",style:{verticalAlign:"-0.2em",marginRight:"6px"}}),"Exit Editor"]})}function Xe(){return b("div",{id:"designer-red-border-overlay",style:{position:"fixed",top:0,left:0,right:0,bottom:0,border:`5px solid ${p.primary}`,pointerEvents:"none",zIndex:p.zIndex.highlight-1,boxSizing:"border-box"}})}function qe(){return b("div",{id:"designer-studio-badge",style:{position:"fixed",top:"4px",left:"50%",transform:"translateX(-50%)",padding:"0px 10px 3px",background:p.primary,color:p.bg,fontSize:"14px",fontWeight:"600",fontFamily:p.fontFamily,borderRadius:"0 0 6px 6px",border:`5px solid ${p.primary}`,borderTop:"none",zIndex:p.zIndex.badge,boxShadow:"0 4px 12px rgba(59, 130, 246, 0.3)",pointerEvents:"none",whiteSpace:"nowrap"},children:"Revgain Visual Design Studio"})}function Je(){return b("div",{id:"designer-loading-overlay",style:{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(255, 255, 255, 0.95)",zIndex:p.zIndex.loading,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:p.fontFamily},children:[b("div",{style:{width:48,height:48,border:"4px solid #e2e8f0",borderTopColor:p.primary,borderRadius:"50%",animation:"spin 1s linear infinite",marginBottom:16}}),b("style",{children:"@keyframes spin { to { transform: rotate(360deg); } }"}),b("div",{style:{color:"#1e40af",fontSize:16,fontWeight:500,fontFamily:p.fontFamily},children:"Loading Visual Designer..."})]})}function Qe(t){return b(P,{children:[t.showExitButton&&b(We,{onExit:t.onExitEditor}),t.showRedBorder&&b(Xe,{}),t.showBadge&&b(qe,{}),t.showLoading&&b(Je,{})]})}function Ze(t,e){z(b(Qe,{...e}),t)}class ee{config;storage;editorMode;guideRenderer;featureHeatmapRenderer;editorFrame;heatmapEnabled=!1;isInitialized=!1;isEditorMode=!1;sdkRoot=null;showLoading=!1;constructor(e={}){this.config=e,this.storage=new je(e.storageKey),this.editorMode=new Me,this.guideRenderer=new Ge,this.featureHeatmapRenderer=new Ke,this.editorFrame=new $e}init(){if(this.isInitialized)return;this.isInitialized=!0,this.injectMontserratFont(),this.injectIconifyScript(),this.guideRenderer.setOnDismiss(n=>this.config.onGuideDismissed?.(n)),this.shouldEnableEditorMode()?(this.showLoading=!0,this.renderOverlays(),this.enableEditor()):this.loadGuides(),this.heatmapEnabled=localStorage.getItem("designerHeatmapEnabled")==="true",this.renderFeatureHeatmap(),this.setupEventListeners()}enableEditor(){if(this.isEditorMode)return;this.isEditorMode=!0;let e=typeof window<"u"&&window.__visualDesignerMode||null;e||(e=localStorage.getItem("designerModeType")||null),this.editorFrame.create(i=>this.handleEditorMessage(i),e);const n=e==="tag-page"||e==="tag-feature";n||this.editorMode.activate(i=>this.handleEditorMessage(i)),this.ensureSDKRoot(),this.showLoading=!1,this.renderOverlays(),localStorage.setItem("designerMode","true"),e&&localStorage.setItem("designerModeType",e),setTimeout(()=>{this.editorFrame.show(),this.renderOverlays()},n?100:300)}disableEditor(){if(this.isEditorMode){try{window.close()}catch{}this.isEditorMode=!1,this.editorMode.deactivate(),this.editorFrame.destroy(),this.featureHeatmapRenderer.destroy(),this.showLoading=!1,localStorage.removeItem("designerMode"),localStorage.removeItem("designerModeType"),this.renderOverlays(),this.loadGuides()}}getGuides(){return this.storage.getGuides()}getGuidesForCurrentPage(){return this.storage.getGuidesByPage(Y())}saveGuide(e){const n={...e,id:oe(),createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};return this.storage.saveGuide(n),this.isEditorMode||this.loadGuides(),this.config.onGuideSaved?.(n),n}deleteGuide(e){this.storage.deleteGuide(e),this.guideRenderer.dismissGuide(e)}loadGuides(){this.guideRenderer.renderGuides(this.storage.getGuides())}isEditorModeActive(){return this.isEditorMode}shouldEnableEditorMode(){return this.config.editorMode!==void 0?this.config.editorMode:typeof window<"u"&&window.__visualDesignerWasLaunched?!0:localStorage.getItem("designerMode")==="true"}handleEditorMessage(e){switch(e.type){case"ELEMENT_SELECTED":this.handleElementSelected(e);break;case"SAVE_GUIDE":this.handleSaveGuide(e);break;case"TAG_FEATURE_CLICKED":this.editorMode.activate(n=>this.handleEditorMessage(n));break;case"ACTIVATE_SELECTOR":this.editorMode.activate(n=>this.handleEditorMessage(n));break;case"CLEAR_SELECTION_CLICKED":this.editorMode.deactivate(),this.editorFrame.sendClearSelectionAck();break;case"SAVE_TAG_PAGE":this.handleSaveTagPage(e);break;case"SAVE_TAG_FEATURE":this.handleSaveTagFeature(e);break;case"HEATMAP_TOGGLE":this.handleHeatmapToggle(e.enabled);break;case"CANCEL":this.editorFrame.hide();break;case"EXIT_EDITOR_MODE":this.disableEditor();break;case"EDITOR_READY":this.showLoading=!1,this.renderOverlays();break}}handleElementSelected(e){this.editorFrame.sendElementSelected(e)}handleSaveGuide(e){this.saveGuide({...e.guide,page:Y()})}handleSaveTagPage(e){const n="designerTaggedPages";try{const i=localStorage.getItem(n)||"[]",o=JSON.parse(i),r=typeof window<"u"?window.location.href:"";o.push({pageName:e.payload.pageName,url:r}),localStorage.setItem(n,JSON.stringify(o))}catch{}this.editorFrame.sendTagPageSavedAck()}handleSaveTagFeature(e){const n="designerTaggedFeatures",i=e.payload;if(!(!i.selector||!i.featureName))try{const o=localStorage.getItem(n)||"[]",r=JSON.parse(o),s=typeof window<"u"?window.location.href:"",l={id:oe(),featureName:i.featureName,selector:i.selector,url:s,elementInfo:i.elementInfo,createdAt:new Date().toISOString()};r.push(l),localStorage.setItem(n,JSON.stringify(r)),this.editorFrame.sendTagFeatureSavedAck(),this.renderFeatureHeatmap()}catch{}}handleHeatmapToggle(e){this.heatmapEnabled=e;try{localStorage.setItem("designerHeatmapEnabled",String(e))}catch{}this.renderFeatureHeatmap()}getTaggedFeatures(){try{const e=localStorage.getItem("designerTaggedFeatures")||"[]";return JSON.parse(e)}catch{return[]}}renderFeatureHeatmap(){this.featureHeatmapRenderer.render(this.getTaggedFeatures(),this.heatmapEnabled)}setupEventListeners(){let e,n;const i=()=>{this.guideRenderer.updatePositions(this.storage.getGuides())},o=()=>{this.featureHeatmapRenderer.updatePositions(this.getTaggedFeatures())};window.addEventListener("resize",()=>{clearTimeout(e),e=window.setTimeout(()=>{i(),o()},100)}),window.addEventListener("scroll",()=>{clearTimeout(n),n=window.setTimeout(()=>{i(),o()},50)},!0)}ensureSDKRoot(){if(!this.sdkRoot){if(!document.body){if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",()=>this.ensureSDKRoot());return}setTimeout(()=>this.ensureSDKRoot(),100);return}this.sdkRoot=document.createElement("div"),this.sdkRoot.id="designer-sdk-root",document.body.appendChild(this.sdkRoot)}}renderOverlays(){this.ensureSDKRoot(),this.sdkRoot&&Ze(this.sdkRoot,{showExitButton:this.isEditorMode,showRedBorder:this.isEditorMode,showBadge:this.isEditorMode,showLoading:this.showLoading,onExitEditor:()=>this.disableEditor()})}injectMontserratFont(){if(typeof document>"u"||!document.head||document.getElementById("designer-montserrat-font"))return;const e=document.createElement("link");e.id="designer-montserrat-font",e.rel="stylesheet",e.href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&display=swap",document.head.appendChild(e)}injectIconifyScript(){if(typeof document>"u"||!document.head||document.getElementById("designer-iconify-script"))return;const e=document.createElement("script");e.id="designer-iconify-script",e.src="https://code.iconify.design/iconify-icon/3.0.2/iconify-icon.min.js",e.async=!0,document.head.appendChild(e)}}let _=null,Se=!1;function C(t){return _||(_=new ee(t),_.init(),_)}function te(){return _}function ne(t){!t||!Array.isArray(t)||t.forEach(e=>{if(!e||!Array.isArray(e)||e.length===0)return;const n=e[0],i=e.slice(1);try{switch(n){case"initialize":C(i[0]);break;case"identify":i[0]&&console.log("[Visual Designer] identify (snippet) called with:",i[0]);break;case"enableEditor":(_??C()).enableEditor();break;case"disableEditor":_?.disableEditor();break;case"loadGuides":_?.loadGuides();break;case"getGuides":return _?.getGuides();default:console.warn("[Visual Designer] Unknown snippet method:",n)}}catch(o){console.error("[Visual Designer] Error processing queued call:",n,o)}})}if(typeof window<"u"){const t=window.visualDesigner;t&&Array.isArray(t._q)&&(Se=!0,t.initialize=e=>C(e),t.identify=e=>{e&&console.log("[Visual Designer] identify (snippet) called with:",e)},t.enableEditor=()=>(_??C()).enableEditor(),t.disableEditor=()=>_?.disableEditor(),t.loadGuides=()=>_?.loadGuides(),t.getGuides=()=>_?.getGuides(),t.getInstance=te,t.init=C,ne(t._q));try{const e=new URL(window.location.href),n=e.searchParams.get("designer"),i=e.searchParams.get("mode");n==="true"&&(i&&(window.__visualDesignerMode=i,localStorage.setItem("designerModeType",i)),localStorage.setItem("designerMode","true"),e.searchParams.delete("designer"),e.searchParams.delete("mode"),window.history.replaceState({},"",e.toString()),window.__visualDesignerWasLaunched=!0)}catch{}}if(typeof window<"u"&&!_&&!Se){const t=()=>{_||C()};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t):t()}typeof window<"u"&&(window.VisualDesigner={init:C,initialize:C,getInstance:te,DesignerSDK:ee,_processQueue:ne}),k.DesignerSDK=ee,k._processQueue=ne,k.getInstance=te,k.init=C,Object.defineProperty(k,Symbol.toStringTag,{value:"Module"})}));
